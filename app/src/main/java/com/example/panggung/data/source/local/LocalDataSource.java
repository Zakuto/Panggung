...
package com.example.panggung.data.source.local;
...
import com.example.panggung.data.source.local.provider.MovieContract.MovieEntry;
import com.example.panggung.util.RepositoryUtils;
